    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{ route('logout')}}" onclick="return confirm('Bạn Có Muốn Đăng Xuất Không?')"><i class="fa fa-key"></i>Đăng Xuất</a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('addCategory-Products') }}">Thêm Danh Mục Sản Phẩm</a></li>
						<li><a href="{{ route('listCategories-Products') }}">Danh Sách Danh Mục Sản Phẩm</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('addBrand') }}">Thêm Thương Hiệu Sản Phẩm</a></li>
						<li><a href="{{ route('listBrand') }}">Danh Sách Thương Hiệu Sản Phẩm</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('addProduct') }}">Thêm Slider</a></li>
						<li><a href="{{ route('listProduct') }}">Danh Sách Slider</a></li>
                    </ul>
                </li>
