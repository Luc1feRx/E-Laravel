        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('view-order', $item->order_id) }}" style="font-size: 20px;" class="active" ui-toggle-class="">

                    <i class="fa fa-pencil-square-o text-success text-active"></i>

                </a>

                <a href="{{route('delete-order', $item->order_id)}}" onclick="return confirm('Bạn Có Muốn Xóa Không?')" style="font-size: 20px;" class="active" ui-toggle-class="">
