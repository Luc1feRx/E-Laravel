            ...
            <tr>
              ...
              <td><span class="text-ellipsis">
                ...
                @if ($item->category_status == 1)
                    <a href="{{route('unactived-status', $item->category_id)}}"><span><i style="font-size: 23px; color: green;" class="fa fa-thumbs-up"></i></span></a>
                @else
                    <a href="{{route('actived-status', $item->category_id)}}"><span><i style="font-size: 23px; color: red;" class="fa fa-thumbs-down"></i></span></a>
                @endif
