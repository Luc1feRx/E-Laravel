@extends('layout')
@section('contents')
@foreach ($detailProduct as $productDetail)
<div class="product-details"><!--product-details-->
    <div class="col-sm-5">
        <div class="view-product">
            <img src="{{ asset('public/upload/product/' . $productDetail->product_image) }}" alt="" />
            <h3>ZOOM</h3>
        </div>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <p>ID: {{$productDetail->product_id}}</p>
            <img src="images/product-details/rating.png" alt="" />

            <form action="{{ route('save-cart') }}" method="post">
                {{ csrf_field() }}
            <span>
                <span>{{number_format($productDetail->product_price,0,',', '.'). 'VND'}}</span>
                <label>Quantity:</label>
                <input name="qty" type="number" min="1" value="1" />
                <input name="productid_hidden" type="hidden" value="{{$productDetail->product_id}}" />
                    ...
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="{{ asset('public/upload/product/' . $related->product_image) }}" alt="" />
