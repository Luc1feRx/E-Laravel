            ...
            <div class="single-products">
                    <div class="productinfo text-center">
                        <form action="">
                            ...
                            <button type="button" class="btn btn-default add-to-cart" data-id_product="{{$product->product_id}}" name="add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ Hàng</button>
                        </form>
                    </div>
